...
public interface ISaveQuotationRequestAction
{
    ...
    Task<Common.QuotationRequest.QuotationRequest?> DispatchToVendorsAsync(Guid quotationRequestId, IReadOnlyList<Guid> vendorIds, CancellationToken cancellationToken);
}
