...
public class SqlServerRoleMenuItemStorageClient(ILogger<SqlServerRoleMenuItemStorageClient> logger, ISqlServerDbClient dbClient) : IRoleMenuItemStorageClient
{
    private readonly ILogger<SqlServerRoleMenuItemStorageClient> _logger = logger;
