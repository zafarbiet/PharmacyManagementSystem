...
public class SqlServerAuditLogStorageClient(ILogger<SqlServerAuditLogStorageClient> logger, ISqlServerDbClient dbClient) : IAuditLogStorageClient
{
    private readonly ILogger<SqlServerAuditLogStorageClient> _logger = logger;
