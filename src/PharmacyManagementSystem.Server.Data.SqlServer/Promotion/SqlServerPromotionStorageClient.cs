...
public class SqlServerPromotionStorageClient(ILogger<SqlServerPromotionStorageClient> logger, ISqlServerDbClient dbClient) : IPromotionStorageClient
{
    private readonly ILogger<SqlServerPromotionStorageClient> _logger = logger;
