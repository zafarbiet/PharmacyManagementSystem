...
public class SqlServerMenuItemStorageClient(ILogger<SqlServerMenuItemStorageClient> logger, ISqlServerDbClient dbClient) : IMenuItemStorageClient
{
    private readonly ILogger<SqlServerMenuItemStorageClient> _logger = logger;
