...
namespace PharmacyManagementSystem.Server.Data.SqlServer.DrugCategory;

public class SqlServerDrugCategoryStorageClient(ILogger<SqlServerDrugCategoryStorageClient> logger, ISqlServerDbClient dbClient) : IDrugCategoryStorageClient
{
    private readonly ILogger<SqlServerDrugCategoryStorageClient> _logger = logger;
