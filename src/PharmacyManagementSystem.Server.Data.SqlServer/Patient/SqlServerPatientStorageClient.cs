...
public class SqlServerPatientStorageClient(ILogger<SqlServerPatientStorageClient> logger, ISqlServerDbClient dbClient) : IPatientStorageClient
{
    private readonly ILogger<SqlServerPatientStorageClient> _logger = logger;
    ...
    public async Task<Common.Patient.Patient?> AddAsync(Common.Patient.Patient? patient, CancellationToken cancellationToken)
    {
        ...
        _logger.LogDebug("StorageClient: Adding patient with name: {Name}.", patient.Name);
        ...
        _logger.LogDebug("StorageClient: Added patient with name: {Name}.", patient.Name);
