...
namespace PharmacyManagementSystem.Server.Data.PostgreSql.Drug;

public class NpgsqlDrugStorageClient(ILogger<NpgsqlDrugStorageClient> logger, INpgsqlDbClient dbClient) : IDrugStorageClient
{
    private readonly ILogger<NpgsqlDrugStorageClient> _logger = logger;
