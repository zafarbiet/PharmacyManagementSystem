...
public class NpgsqlNotificationStorageClient(ILogger<NpgsqlNotificationStorageClient> logger, INpgsqlDbClient dbClient) : INotificationStorageClient
{
    private readonly ILogger<NpgsqlNotificationStorageClient> _logger = logger;
