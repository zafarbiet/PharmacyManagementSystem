...
public class NpgsqlQuotationStorageClient(ILogger<NpgsqlQuotationStorageClient> logger, INpgsqlDbClient dbClient) : IQuotationStorageClient
{
    private readonly ILogger<NpgsqlQuotationStorageClient> _logger = logger;
