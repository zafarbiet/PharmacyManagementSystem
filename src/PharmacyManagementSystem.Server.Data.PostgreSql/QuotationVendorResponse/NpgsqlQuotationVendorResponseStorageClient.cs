...
public class NpgsqlQuotationVendorResponseStorageClient(ILogger<NpgsqlQuotationVendorResponseStorageClient> logger, INpgsqlDbClient dbClient) : IQuotationVendorResponseStorageClient
{
    private readonly ILogger<NpgsqlQuotationVendorResponseStorageClient> _logger = logger;
