...
public class NpgsqlCustomerInvoiceStorageClient(ILogger<NpgsqlCustomerInvoiceStorageClient> logger, INpgsqlDbClient dbClient) : ICustomerInvoiceStorageClient
{
    private readonly ILogger<NpgsqlCustomerInvoiceStorageClient> _logger = logger;
