...
public class NpgsqlManufacturerStorageClient(ILogger<NpgsqlManufacturerStorageClient> logger, INpgsqlDbClient dbClient) : IManufacturerStorageClient
{
    private readonly ILogger<NpgsqlManufacturerStorageClient> _logger = logger;
